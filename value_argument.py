...
#from dateutil.relativedelta import relativedelta
   ...
   #print ("LUIK FUNDAMENTALS")
    ...
    try:
        ...
        #print ("pricesalestrailing",pricesales)
    except:
        print ("price to sales not found = results incorrect")
        pricesales = 0
